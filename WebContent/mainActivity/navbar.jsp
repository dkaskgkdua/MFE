...
<header id="header">
	...
	<div>
		...
		<!--  검색 텍스트 -->
		<form class="search_Text" id="searchForm" method="post" action="searchword.co">
			<input class="search_Text" type="text" name="search_Text" id="search_Text" placeholder="search...">
		</form>
		...
		<c:if test="${!empty id}">
			<c:choose>
				<c:when test="${id=='admin@mfe.com'}">
					<button id="adminMode_Button" type="button" class="btn btn-secondary">
						<span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
					</button>
					<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#account_Modal">
		...
		<c:if test="${empty id}">
			<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#login_Modal">
				<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
			</button>
		</c:if>
					...
					<form method="post" action="loginProcess.net" id="login_form">
						<fieldset>
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" id="login_pass" placeholder="Enter password" name="login_pass" required>
							</div>
							<div class="6u$ 12u$(small)">
								<input type="checkbox" id="login_remember" name="login_remember" checked> <label for="login_remember">Remember
									me</label>
							</div>
