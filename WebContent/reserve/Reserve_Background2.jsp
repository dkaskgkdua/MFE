...
<body>
	...
	<div class="container">
		...
		<div id="detail">
			...
			<div class="Thumbnail">
				<div class="imageWrap">
					<img src="../reserve/image/${c.concert_image}">
				</div>
				<!-- //공연 이미지:썸네일 end -->
				<!-- 공연 타이틀/인기도/날짜(in썸네일)-->
						...
						<div role="tabpanel" class="tab-pane active" id="concert-info">
							...
							<ul>
								<li>티켓 구매 후 티켓을 재 판매하는 행위는 금지되어 있습니다.<br> 
									불법 거래된 티켓은 주최측의 권한으로 사전 통보 없이 취소 처리되며, <br>
									공연 당일 현장에 티켓을 소지하고 오더라도 공연장 입장이 불가함을 알려드립니다.<br>
								</li>
							</ul>
							<div>
								<h3>예매 안내</h3>
							...
							<ul>
								<li>회차당 <strong>1인 4매</strong>까지 구매 가능합니다.</li>
								<li>본 공연은 <strong>만 7세 이상 관람가</strong>로, 관람 연령 미만은 티켓을 소지 하였어도 입장이 불가합니다.</li>
								<li>취소마감시간 이후로는 어떠한 사유로도 티켓 환불이 되지 않습니다.<br> 
									<b>*취소 마감 시간 : 2020년 2월 1일(토) 공연-> 1월 31일(금) 오후 5시까지</b><br>
								</li>
